...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # hidden_error_term =  np.dot(output_error_term, self.weights_hidden_to_output) * hidden_layer_output * (1 - hidden_layer_output)
        ...
        for i in range(len(output_error_term)):
            delta_weights_h_o += output_error_term[i] *hidden_outputs[i]
    ...
    def run(self, features):
        ...
        hidden_outputs = self.activation_function(features.dot(self.weights_input_to_hidden)) # signals from hidden layer
